...
#ifndef OPENFACE_UTILSPROCESSCAM_H
#define OPENFACE_UTILSPROCESSCAM_H

#endif //OPENFACE_UTILSPROCESSCAM_H
...
void visualise_tracking(cv::Mat& captured_image, cv::Mat& neutralImg, cv::Mat& negativeImg, cv::Mat& positiveImg, const LandmarkDetector::CLNF& face_model,
